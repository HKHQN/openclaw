...
# ✅ Cache mounts đã xóa — Railway compatible
RUN apt-get update && \
...
RUN chown node:node /app && \
    mkdir -p /home/node/.openclaw && mkdir -p /data/.openclaw && \
    chown -R node:node /home/node && chown -R node:node /data && \
    chmod -R 755 /home/node && chmod -R 755 /data
